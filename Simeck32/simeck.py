...
def make_train_data(n, nr, a=((0x0,0x1), (0x0,0x4), (0x0,0x8)), b=((0x0,0x0020),(0x0,0x0010),(0x0,0x0040)), s_groups=1): 
...
def make_train_rkdata(n, nr, a=((0x0,0x1), (0x0,0x4), (0x0,0x8)), b=((0x0,0x0020),(0x0,0x0010),(0x0,0x0040)), s_groups=1): 
...
from tensorflow.keras.layers import multiply,GlobalAvgPool1D,Dense, Conv1D, Input, Reshape, Add, Flatten, BatchNormalization, Activation
